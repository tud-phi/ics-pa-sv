...
from jax_double_pendulum.robot_simulation import _simulate_robot_jitted

# import feedback controller from controllers.ipynb
from ipynb.fs.full.controllers import ctrl_fb_pd


def init_ilc_its(num_iterations: int, traj_ts: Dict[str, Array]) -> Dict[str, Array]:
    """
