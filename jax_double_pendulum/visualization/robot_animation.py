...
def animate_robot(
    ...
    sim_hat_ts: Dict[str, Array] = None,
    traj_ts: Dict[str, Array] = None,
    ...
    def _animate(time_idx: int):
        ...
        if line_ee_pos is not None:
            line_ee_pos.set_data(
                sim_ts["x_ts"][time_idx:time_idx+1, 0], sim_ts["x_ts"][time_idx:time_idx+1, 1]
            )
        ...
        if line_ee_pos_hat is not None:
            line_ee_pos_hat.set_data(
                sim_hat_ts["x_ts"][time_idx:time_idx+1, 0], sim_hat_ts["x_ts"][time_idx:time_idx+1, 1]
            )
        ...
        if line_ref_pos is not None:
            line_ref_pos.set_data(
                traj_ts["x_ts"][time_idx:time_idx+1, 0], traj_ts["x_ts"][time_idx:time_idx+1, 1]
            )
