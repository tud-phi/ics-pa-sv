...
##
#  See also: NotebookClient.timeout
# c.Execute.timeout = 300  # s

##
#  See also: NotebookClient.timeout_func
# c.Execute.timeout_func = None
c.Execute.timeout_func = lambda cell: 600  # s
...
c.Autograde.exclude_overwriting = {
    "problem_2": [
        "cache/q_ilc_target.npz",
        "cache/q_ilc.npz",
        "datasets/dataset_double_pendulum_dynamics.npz",
        "datasets/upper_bound_dataset_double_pendulum_dynamics.npz",
        "statedicts/best_model_cnn.pt",
        "statedicts/task_2c_lagrangian_nn_params.pkl",
        "statedicts/upper_bound_task_2c_lagrangian_nn_params.pkl",
    ],
    "problem_3": [
        "statedicts/task_3-10-3_trained_Q_table.npy",
    ],
}
